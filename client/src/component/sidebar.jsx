...
export function Sidebar({ currentView, onViewChange, isOpen = true, onClose }) {
      ...
      <aside className={`w-64 h-screen bg-white border-r border-gray-200 flex flex-col fixed md:static z-40 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        <div className="p-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-bold text-xl text-gray-900">LinkSaver</h1>
          </div>
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider font-semibold">Organize your resources</p>
        </div>
