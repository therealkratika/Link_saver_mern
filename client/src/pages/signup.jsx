...
import { AuthSDK } from "../Api/AuthSDK"; // ✅ add this
...
export function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await AuthSDK.signup({ name, email, password }); // ✅ backend call
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md transition-all duration-500 ease-out opacity-100 translate-y-0">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Start organizing your resources today</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" className="mt-1 rounded text-blue-600 focus:ring-blue-500" required id="terms" />
